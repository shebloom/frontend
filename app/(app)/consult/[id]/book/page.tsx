...
export default function BookingPage() {
  ...
  return (
    <div className="min-h-screen bg-lavender-100 pb-20">
      {/* Header */}
      ...
      <div className="px-5 pt-6">
        ...
        {/* Action */}
        <div className="fixed bottom-0 left-0 w-full bg-white px-5 py-4 shadow-[0_-4px_20px_-10px_rgba(0,0,0,0.1)] mx-auto max-w-[414px] left-1/2 -translate-x-1/2">
          <GradientButton 
            onClick={handleBook} 
